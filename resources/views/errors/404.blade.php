...
<div class="wrapper box-layout error-page pa-0">
    <header class="sp-header">
        <div class="sp-logo-wrap pull-left">
            <a href="{{ URL::to('login') }}">
                <img class="brand-img mr-10" src="{{ asset('public/img/logo.gif') }}" alt="brand"/>
                <span class="brand-text">aBill</span>
            </a>
        </div>
        <div class="form-group mb-0 pull-right">
            <a class="inline-block btn btn-warning btn-rounded btn-outline nonecase-font" href="{{ URL::to('login') }}">Back
                to Home</a>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="mb-30">
                                    ...
                                    <p class="text-center">The URL may be misplaced or the page you are looking is no
                                        longer available.</p>
                                </div>
                            </div>
                        </div>
