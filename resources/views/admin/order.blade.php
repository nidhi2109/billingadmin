                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label mb-10" for="filterBy">Filter
                                                                By</label>
                                                            <div class="input-group">
                                                                <div class="input-group-addon"><i class="icon-user"></i>
                                                                </div>
                                                                <input type="text" class="form-control" name="filterBy"
                                                                       id="filterBy"
                                                                       placeholder="ID, Number or Description">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <select name="typeId" id="typeId" class="form-control"
                                                                    ...
                                                                    <option value="280201">DhavalLatepaymentpenalty1
                                                                    </option>
                                                                    <option value="280200">DhavalLatepaymentpenalty
                                                                    </option>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-wrap">
                                            <form>
                                                <div class="form-group">
                                                    <label class="control-label mb-10" for="exampleInputuname_2">User
                                                        Name</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="exampleInputuname_2"
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label mb-10"
                                                           for="exampleInputpwd_3">Password</label>
                                                    <div class="input-group">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label mb-10" for="exampleInputpwd_42">Confirm
                                                        Password</label>
                                                    <div class="input-group">
                                                        <input type="password" class="form-control"
                                                               id="exampleInputpwd_42"
                                                               placeholder="Enter pwd">
                                                        <div class="input-group-addon"><i class="icon-lock"></i></div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <div class="radio">
                                                            <input type="radio" name="radio2" id="radio_3"
                                                                   value="option1"
                                                                   checked="">
                                                            <label for="radio_3">
                                                                M
                                                        ...
                                                        <div class="radio">
                                                            <input type="radio" name="radio2" id="radio_4"
                                                                   value="option2"
                                                                   checked="">
                                                            <label for="radio_4">
                                                                F
