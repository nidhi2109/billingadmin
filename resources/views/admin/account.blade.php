                                    ...
                                    <div class="panel-body  pa-0">
                                        <div class="profile-box">
                                            ...
                                            <div class="profile-info text-center">
                                                <div class="profile-img-wrap">
                                                    <img class="inline-block mb-10"
                                                         src="{{ asset('public/img/mock1.jpg') }}" alt="user">
                                                </div>
                                            ...
                                            <div class="social-info">
                                                ...
                                                {{--</div>--}}
                                                {{--</div>--}}
                                                <button class="btn btn-warning btn-block btn-anim mt-30"
                                                        data-toggle="modal" data-target="#myModal"><i
                                                            class="fa fa-pencil"></i><span class="btn-text">Edit Password</span>
                                                </button>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content col-lg-8">
                                                                                            ...
                                                                                            <form action="#"
                                                                                                ...
                                                                                                <div class="form-body overflow-hide">
                                                                                                    <div class="form-group">
                                                                                                        <label class="control-label mb-6"
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit"
                                                                        class="btn btn-success waves-effect">Save
                                                                </button>
                                                                <button type="button"
                        ...
                        <div class="col-lg-6">
                            <form action="{{ route('accountUpdate') }}" method="post">
                                ...
                                <div class="form-wrap">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" value="{{ $account['userId'] }}" name="userId"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="userName" value="{{ $account['userName'] }}"
                                                       class="form-control" id="userName" placeholder="willard bryant"
                                                       disabled="disabled">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="control-label mb-10" for="organizationName">Organization
                                                Name</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                <input type="text" name="organizationName"
                                                       value="{{ $account['contact']['organizationName'] }}"
                                                       class="form-control" id="organizationName"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="firstName"
                                                       ...
                                                       class="form-control" id="firstName" placeholder="willard bryant">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="lastName"
                                                       ...
                                                       class="form-control" id="lastName" placeholder="willard bryant">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="email" id="email" placeholder="email"
                                                       value="{{ $account['contact']['email'] }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="address1" id="address1" placeholder="address1"
                                                       value="{{ $account['contact']['address1'] }}"
                                                       class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="address2" id="address2" placeholder="address2"
                                                       value="{{ $account['contact']['address2'] }}"
                                                       class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="city" id="city" placeholder="city"
                                                       value="{{ $account['contact']['city'] }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="control-label mb-10"
                                                   for="stateProvince">State/Province</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="icon-globe"></i></div>
                                                <input type="text" name="stateProvince" id="stateProvince"
                                                       placeholder="state/Province"
                                                       value="{{ $account['contact']['stateProvince'] }}"
                                                       class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="postalCode" id="postalCode"
                                                       ...
                                                       value="{{ $account['contact']['postalCode'] }}"
                                                       class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox checkbox-primary">
                                                <input name="include" id="include" type="checkbox"
                                                       @if($account['contact']['include'] != "false") checked @endif>
                                                <label for="include">
                                    ...
                                    <div class="form-actions mt-10 text-right">
                                        <button type="submit" class="btn btn-success mr-10 mb-30">Update profile
                                        </button>
                                    </div>
                                </div>
                            </form>
